...
export const CourseContainerStyle = styled.div`
...
`;
export const NoCourseUpperSpace = styled.div`
  display: block;
  width: 0px;
  height: 0px;
  ...
  padding: 0px;
`;
export const NoCourseLowerSpace = styled.div`
  display: block;
  width: 0px;
  height: 0px;
  ...
  padding: 0px;
`;
export const NoCourseImg = styled.div`
...
`;
export const NoCourseComment = styled.div`
  font-size: 1rem;
  color: #999;
`;
